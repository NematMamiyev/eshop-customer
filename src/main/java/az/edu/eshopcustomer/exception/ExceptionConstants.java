...
public final class ExceptionConstants {
    ...
    public static final Integer BRAND_NOT_FOUND = 102;
    ...
    public static final Integer PRODUCT_SERVICE_EXCEPTION=123;
    public static final Integer PRODUCT_DETAILS_IS_EMPTY = 124;
}
